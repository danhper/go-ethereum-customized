...
type ChainConfig struct {
	...
	TxChainBlock        *big.Int `json:"txChainBlock,omitempty"`        // TxExists block (nil = no fork, 0 = already activated)
...
// IsTxChain returns whether num is either equal to the TxExists fork block or greater.
func (c *ChainConfig) IsTxChain(num *big.Int) bool {
	return isForked(c.TxChainBlock, num)
}
